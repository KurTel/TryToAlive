 ...
 */
public class GameWorld2Controller extends GameWorldController {

    private World2 world;

    public GameWorld2Controller(GameScreen gameScreen) {
        super(gameScreen);
        this.world = (World2)gameScreen.getGameWorldByNumber(2);
    }
    @Override
    ...
    public boolean pan(float x, float y, float deltaX, float deltaY) {
        ...
        Gdx.app.log("GameWorld2Controller","there");
        return false;
    }
